...
<template>
  <article class="chapter">
    ...
    <p>
      ...
      <a href="https://cli.emberjs.com/">ember-cli</a>. The latest testing API
      is available at
      <a
        href="https://github.com/emberjs/ember-test-helpers/blob/master/API.md"
      >ember-test-helpers</a>.
    </p>
    ...
    <ul class="spec-method-list">
      ...
      <li>Components -
        ...
        >Glimmer</LinkTo>; a view that is completely isolated</li>
      <li><LinkTo
          @route="project-version.functions.function"
          @models={{array "@glimmer/tracking" "tracked"}}
        >Tracked</LinkTo>
        - make your templates responsive to property updates</li>
      <li><LinkTo
          @route="project-version.classes.class"
          @model="ComputedProperty"
        >Computed Properties</LinkTo>
        - declare functions as properties</li>
      {{! template-lint-disable no-potential-path-strings }}
      <li><LinkTo
          @route="project-version.classes.class"
          @model="@ember/object/computed"
        >Computed Macros</LinkTo>
        - shorter ways of expressing certain types of computed properties</li>
      <li>
        <LinkTo
          @route="project-version.classes.class"
          @model="EmberArray"
        ...
        <a href="/ember/{{@version}}/classes/EmberArray#forEach">forEach</a>
        and
      ...
      <li>
        ...
        <a href="/ember/{{@version}}/classes/EmberObject#get">get</a>
        and
        <a href="/ember/{{@version}}/classes/EmberObject#set">set</a>
        methods
      </li>
      <li>
        <LinkTo
          @route="project-version.classes.class"
          @model="Ember.Templates.helpers"
        >Ember.Templates.helpers</LinkTo>
        - built-in functions that can be used in templates, such as the
        <a
          href="/ember/{{@version}}/classes/Ember.Templates.helpers#each"
        >each</a>
        and
        <a href="/ember/{{@version}}/classes/Ember.Templates.helpers#on">on</a>
        helpers
      </li>
      <li><LinkTo
          @route="project-version.classes.class"
          @model="Helper"
        >Helpers</LinkTo>
        - a way to define custom display functions that are used in templates</li>
      <li>
        <LinkTo
          @route="project-version.classes.class"
          @model="Route"
      ...
      <li><LinkTo
        ...
        can be made available in different parts of your application</li>
    </ul>
    <h2>Useful links</h2>
    <ul>
      <li>
