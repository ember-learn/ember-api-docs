...
<template>{{pageTitle @model.version}}
  ...
  <EsSidebar>
   <TableOfProjects @activeProject={{@controller.activeProject}} />
    ...
    <div class="select-container">
      <PowerSelect @onChange={{fn @controller.updateProject @controller.activeProject}} @options={{@controller.projectVersions}} @selected={{@controller.selectedProjectVersion}} @ariaLabel="Select a version" @required={{true}} @searchField="compactVersion" @searchEnabled={{true}} as |ver|>
        {{ver.compactVersion}}
      </PowerSelect>
    </div>
