...
<template>
  ...
  <article class="chapter">
    <div class="article-title-wrapper">
      ...
      {{#if
        (and
          ...
          @model.line
          (isLatest
            version=@model.projectVersion.version
            allVersions=@controller.allVersions
          )
        )
      }}
        <a
        ...
        <div class="attribute">
          ...
          <span class="attribute-value">
            <LinkTo
              ...
              @models={{array
                @model.extendedClassProjectName
                @model.projectVersion.compactVersion
                @model.extendedClassShortName
              }}
          ...
          <span class="attribute-value">
            {{#each @model.usesObjects as |parentClass idx|}}
              ...
              <LinkTo
                @route="project-version.classes.class"
                @models={{array
                  parentClass.projectId
                  @model.projectVersion.compactVersion
                  parentClass.shortName
                }}
                data-test-uses-link
              >{{parentClass.name}}</LinkTo>
            {{/each}}
          </span>
        </div>
      {{/if}}
    ...
    {{/if}}
    <p class="description"><MarkdownToHtml
  ...
  <div class="on-this-page-wrapper">
    ...
    {{#if (or @model.methods @model.properties @model.events)}}
        ...
        <section class="access-checkbox-list">
          <label class="access-checkbox">
            <input
              ...
              type="checkbox"
              checked={{@controller.filterData.showInherited}}
              onchange={{fn @controller.updateFilter "showInherited"}}
            />
            Inherited
          </label>
          <label class="access-checkbox">
            <input
              ...
              type="checkbox"
              checked={{@controller.filterData.showProtected}}
              onchange={{fn @controller.updateFilter "showProtected"}}
            />
            Protected
          </label>
          <label class="access-checkbox">
            <input
              ...
              type="checkbox"
              checked={{@controller.filterData.showPrivate}}
              onchange={{fn @controller.updateFilter "showPrivate"}}
            />
            Private
          </label>
          <label class="access-checkbox">
            <input
              ...
              type="checkbox"
              checked={{@controller.filterData.showDeprecated}}
              onchange={{fn @controller.updateFilter "showDeprecated"}}
            />
            Deprecated
          </label>
        </section>
      ...
      >
        <ApiIndex
          @itemData={{filteredModel}}
          @classNames="api__index__content"
          as |sectionData|
        >
