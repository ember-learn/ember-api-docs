...
module('Unit | Service | meta-store', function (hooks) {
  ...
  const projectRevMap = {
    'ember-2.14.1': {
      class: {
        ...
        'ember-2.14.1-RSVP.EventTarget':
          'ember-2.14.1-RSVP.EventTarget-10cdced26e',
        'ember-2.14.1-RSVP.Promise': 'ember-2.14.1-RSVP.Promise-fbbcd10984',
        'ember-2.14.1-Registry': 'ember-2.14.1-Registry-4c1d3349b8',
        'ember-2.14.1-Ember.ApplicationInstance':
          'ember-2.14.1-Ember.ApplicationInstance-6c74055348',
        'ember-2.14.1-Ember.ApplicationInstance.BootOptions':
          'ember-2.14.1-Ember.ApplicationInstance.BootOptions-d85accfd00',
        'ember-2.14.1-Ember.ContainerDebugAdapter':
          'ember-2.14.1-Ember.ContainerDebugAdapter-a638d957ef',
        'ember-2.14.1-Ember.DataAdapter':
          'ember-2.14.1-Ember.DataAdapter-13d97fba8e',
        'ember-2.14.1-Ember.Checkbox': 'ember-2.14.1-Ember.Checkbox-ac010b20de',
        'ember-2.14.1-Ember.Templates.helpers':
          'ember-2.14.1-Ember.Templates.helpers-8ad35165c6',
        'ember-2.14.1-Ember.LinkComponent':
          'ember-2.14.1-Ember.LinkComponent-1f73e68442',
      },
      namespace: {
        ...
        'ember-2.14.1-Ember.Instrumentation':
          'ember-2.14.1-Ember.Instrumentation-444cd5ed44',
        ...
        'ember-2.14.1-Ember.AutoLocation':
          'ember-2.14.1-Ember.AutoLocation-4b8744f1e4',
      },
      module: {
        'ember-2.14.1-ember': 'ember-2.14.1-ember-d11dc7bcaf',
        'ember-2.14.1-ember-application':
          'ember-2.14.1-ember-application-f34af3b30d',
        'ember-2.14.1-ember-extension-support':
          'ember-2.14.1-ember-extension-support-46321b0650',
      },
      missing: {
        EmberObject: 'EmberObject-9bb68cdfb6',
        Error: 'Error-158974c414',
      },
    },
  };
  ...
  test('correct version selected', function (assert) {
    let service = this.owner.lookup('service:meta-store');
    service.set('availableProjectVersions.ember', [
      '2.15.0',
      '2.14.1',
      '2.13.4',
      '1.0.0',
