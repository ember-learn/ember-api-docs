...
test('reset scroll on transitions', async function(assert) {
  ...
  await visit('/ember/1.0.0/classes/Ember.View');
  ...
  await visit('ember/1.0.0/modules/runtime');
  ...
  await visit('ember/1.0.0/namespaces/Ember.run');
  ...
  await visit('ember/1.0.0/classes/Ember.RenderBuffer/');
  ...
  await visit('ember/1.0.0/classes/Ember.RenderBuffer/properties');
  ...
  await visit('ember/1.0.0/classes/Ember.RenderBuffer/methods');
  ...
  await visit('ember/1.0.0/classes/Ember.Route/methods');
