...
module('Acceptance | ItemRoutes', function (hooks) {
  ...
  test('Can navigate to method from class', async function (assert) {
    ...
    assert.equal(
      currentURL(),
      '/ember/1.0/classes/Container/methods/child?anchor=child',
      'navigated to method'
    );
  });
  ...
  test('Can navigate to method from method name', async function (assert) {
    ...
    assert.equal(
      currentURL(),
      '/ember/1.0/classes/Container/methods/child?anchor=register',
      'navigated to method from method name'
    );
  });
  ...
  test('Can navigate to property from class', async function (assert) {
    ...
    assert.equal(
      currentURL(),
      '/ember/1.0/classes/Container/properties/cache?anchor=cache',
      'navigated to property'
    );
  });
  ...
  test('Can navigate to method from namespace', async function (assert) {
    ...
    assert.equal(
      currentURL(),
      '/ember/1.0/namespaces/Ember/methods/A?anchor=A',
      'navigated to method'
    );
  });
  ...
  test('Can navigate to property from namespace', async function (assert) {
    ...
    assert.equal(
      currentURL(),
      '/ember/1.0/namespaces/Ember/properties/ENV?anchor=ENV',
      'navigated to property'
    );
  });
  ...
  test('Can navigate to event from namespace', async function (assert) {
    ...
    assert.equal(
      currentURL(),
      '/ember/1.0/namespaces/Ember/events/onerror?anchor=onerror',
      'navigated to event'
    );
  });
});
