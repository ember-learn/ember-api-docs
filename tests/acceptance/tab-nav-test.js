...
module('Acceptance | tab navigation', function(hooks) {
  ...
  test('switching tabs', async function(assert) {
    ...
    assert.ok(
      find(`.tabbed-layout__menu ${'[data-test-tab="methods"]'}`).classList.contains(
    ...
    assert.ok(
      find(`.tabbed-layout__menu ${'[data-test-tab="properties"]'}`).classList.contains(
        'tabbed-layout__menu__item_selected'
      ),
    ...
    assert.ok(
      find(`.tabbed-layout__menu ${'[data-test-tab="events"]'}`).classList.contains(
        'tabbed-layout__menu__item_selected'
      ),
      'events tab selected'
    );
    ...
    assert.ok(
      find(`.tabbed-layout__menu ${'[data-test-tab="index"]'}`).classList.contains(
        'tabbed-layout__menu__item_selected'
      ),
      'index tab selected'
    );
